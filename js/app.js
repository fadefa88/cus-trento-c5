...
function standings(){const isU21=view.standings==="u21";const table=isU21?state.u21Standings:state.standings;const title=isU21?"Under 21":"Prima squadra";shell("Stagione","Classifica",`${teamSwitch("standings")}<div class="card card-pad table-wrap"><h2>Classifica ${title}</h2><table class="table" style="box-shadow:none;margin-top:16px"><thead><tr><th>#</th><th>Squadra</th><th>PT</th><th>G</th><th>V</th><th>N</th><th>P</th><th>GF</th><th>GS</th><th>DR</th></tr></thead><tbody>${tableRows(table,isU21?"CUS Trento U21":"CUS TRENTO")}</tbody></table></div>` ,"","Classifica Serie C1 e Under 21.");}
...
function historicalStatsPage(){
  ...
  shell("Archivio statistiche","Statistiche storiche complete",`
    ...
    <div class="grid grid-4" style="margin-bottom:22px">
      ...
      <div class="stat-tile"><b>${numIt(s.goalsFor)}</b><span>Gol fatti (${s.goalsForAvg})</span></div>
      <div class="stat-tile"><b>${numIt(s.goalsAgainst)}</b><span>Gol subiti (${s.goalsAgainstAvg})</span></div>
