...
function newsShareButtons(n,compact=false){
  ...
  return `<div class="news-share ${compact?'compact':''}" onclick="event.stopPropagation()">
    ...
    <a class="share-action share-facebook" href="https://www.facebook.com/sharer/sharer.php?u=${encUrl}&quote=${encTitle}" target="_blank" rel="noopener noreferrer" ${stop} data-news-share-action="facebook" data-news-url="${safeUrl}" data-news-title="${safeTitle}" aria-label="Condividi su Facebook"><span class="share-icon" aria-hidden="true"><i class="fa-brands fa-facebook-f"></i></span><span>Facebook</span></a>
...
function setupNewsShareHandlers(){
  ...
  document.addEventListener('click',event=>{
    ...
    if(action==='facebook'){
      ...
      const fbUrl=`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(payload.url)}&quote=${encodeURIComponent(payload.title||'CUS Trento C5')}`;
      const opened=window.open(fbUrl,'_blank','noopener,noreferrer');
      if(!opened) window.location.href=fbUrl;
      return;
    }
    event.preventDefault();
...
function youtubeEmbedUrl(url){
  ...
  // Non mettere mai youtube.com generico dentro un iframe: viene rifiutato dal browser.
