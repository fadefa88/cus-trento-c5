...
function homeSocialSection(){return `<section class="section social-home-section"><div class="container"><div class="head"><div><span class="eyebrow">Social wall</span><h2 class="title">Ultimi dai social</h2></div><button class="btn soft" onclick="route('social')">Apri social wall</button></div>${socialGrid(2)}</div></section>`;}
