...
function videoThumb(v){
  return v.thumb || youtubeThumb(v.url) || "https://custrentocalcioa5.it/img/placeholder.webp";
}
...
async function loadSocialFeed(){
  try{
    const res = await fetch(`content/social-feed.json?v=${Date.now()}`, {cache:'no-store'});
    if(!res.ok){
