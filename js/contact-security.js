(() => {
  ...
  function installRealRouteLinks() {
    ...
    const css = `html{scroll-behavior:auto!important}.nav a,.home-structure a,.cus-rework-page a{text-decoration:none}.nav-main{display:inline-flex;align-items:center;border:0}.dropdown a{display:block;width:100%;text-align:left;border-radius:10px;padding:11px 13px;background:#fff;font-weight:600;color:#3f3f46}.dropdown a:hover,.dropdown a.active{background:#f4f4f5;color:var(--red)}.mobile-menu a{display:block;width:100%;text-align:left;background:#f4f4f5;border-radius:10px;padding:10px;margin-top:8px;font-weight:600;color:inherit}.mobile-menu a.active{background:#fee2e2;color:#b91c1c}.home-structure-card-head a{border-radius:999px;background:#f4f4f5;color:#18181b;padding:8px 12px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.08em}.home-structure-card-cup .home-structure-card-head a{background:#fff;color:#09090b}.home-structure-cta-card a{display:inline-flex;align-items:center;justify-content:center;background:#fff;color:#09090b;border-radius:var(--r-sm);padding:12px 17px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.06em}@media (max-width:640px) and (orientation:portrait){.hero .home-hero-actions{align-items:flex-start!important;max-width:230px!important}.hero .home-hero-actions a.btn,.hero .home-hero-actions .btn{display:inline-flex!important;flex:0 0 auto!important;width:fit-content!important;min-width:0!important;max-width:max-content!important;align-self:flex-start!important;justify-content:flex-start!important;padding:10px 13px!important;font-size:12px!important;line-height:1.1!important;white-space:nowrap!important}}`;
