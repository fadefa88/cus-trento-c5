(function(){
  ...
  function latestThreeNews(){
    const s = typeof state !== "undefined" ? state : {};
    const items = typeof visibleNews === "function" ? visibleNews(s.news) : (s.news || []);
    return [...items]
  ...
  function heroSection(){
    ...
    return `<section class="hero"><div class="container hero-grid"><div><span class="tag">Serie B</span><span class="tag ghost">Stagione 26/27</span><h1>CUS Trento C5</h1><p class="lead lead-strong">Il futsal universitario di Trento</p><p class="lead">Una squadra, una community, un progetto che unisce sport, università e territorio. Segui la stagione, vivi gli eventi e sostieni il futsal targato UniTrento.</p><div class="btns home-hero-actions"><button class="btn" onclick="route('play-with-us')"><i class="fa-solid fa-futbol" aria-hidden="true"></i><span>Gioca con noi</span></button><button class="btn light" onclick="route('become-partner')"><i class="fa-solid fa-handshake" aria-hidden="true"></i><span>Diventa sponsor</span></button><button class="btn ghost" onclick="route('events')"><i class="fa-solid fa-calendar-days" aria-hidden="true"></i><span>Scopri gli eventi</span></button></div></div><div class="home-hero-socials" aria-label="Profili social CUS Trento C5"><a href="https://www.instagram.com/custrentoc5/" target="_blank" rel="noopener noreferrer" aria-label="Instagram CUS Trento C5"><i class="fa-brands fa-instagram" aria-hidden="true"></i></a><a href="https://www.tiktok.com/@custrentoc5" target="_blank" rel="noopener noreferrer" aria-label="TikTok CUS Trento C5"><i class="fa-brands fa-tiktok" aria-hidden="true"></i></a><a href="https://www.youtube.com/@custrentoc5" target="_blank" rel="noopener noreferrer" aria-label="YouTube CUS Trento C5"><i class="fa-brands fa-youtube" aria-hidden="true"></i></a></div></div></section>`;
  }
